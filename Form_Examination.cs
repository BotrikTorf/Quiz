...
namespace Quiz
{
    public partial class Form_Examination : Form // форма для проверки умножения
    {
        ...
        public Form_Examination(int param)
        {
            this.param = param;
            InitializeComponent();
            Creates_Text_Box();
        ...
        string Text_Prim(int i)
        {
            ...
            sum[i] = rezul;
            return first_term.ToString() + " x " + second_term.ToString() + " =";
