...
namespace Quiz
{
    public partial class Form_Subtraction : Form //форма для проверки вычитания
    {
        private TextBox[] textBox;
        private Label[] labels_prim;
        private PictureBox[] picture_boxes;
        private int znach = Form_Start.znach;
        private int[] subtraction = new int[30];
        ...
        public Form_Subtraction(int param)
        {
            this.param = param;
            InitializeComponent();
            Creates_Text_Box();
        ...
        private void Creates_Text_Box()
        {
            ...
            for (int i = 0; i < textBox.Length; i++)
            {
                ...
                if (i < 10) textBox[i].Location = new Point(110, i * 35 + 12);
                else if (i >= 20) textBox[i].Location = new Point(110 + 550, (i - 20) * 35 + 12);
                else textBox[i].Location = new Point(110 + 250, (i - 10) * 35 + 12);
        ...
        private void Creates_Picture_Box()
        {
            ...
            for (int i = 0; i < picture_boxes.Length; i++)
            {
                ...
                if (i < 10) picture_boxes[i].Location = new Point(175, i * 35 + 15);
                else if (i >= 20) picture_boxes[i].Location = new Point(175 + 550, (i - 20) * 35 + 15);
                else picture_boxes[i].Location = new Point(175 + 250, (i - 10) * 35 + 15);
        ...
        private void Proverka(int i)
        {
            ...
            if (int.TryParse(textBox[i].Text, out int rez) && subtraction[i] == rez)
